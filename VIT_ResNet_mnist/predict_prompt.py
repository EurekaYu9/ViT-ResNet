...
def zero_shot_evaluation(model, data_loader, device):
    ...
    # 文本描述
    text_descriptions = [
        "A photo of handwritten digit 0, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 1, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 2, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 3, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 4, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 5, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 6, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 7, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 8, which might be irregular and may have some corrections or erasures.",
        "A photo of handwritten digit 9, which might be irregular and may have some corrections or erasures."
    ]
